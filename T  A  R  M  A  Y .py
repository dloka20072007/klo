...
g= datetime.datetime(2023, 10, 8, 1, 00 ,0)
...
𝕍𝔼ℝ𝕊𝕀𝕆ℕ➙   6
\x1b[1;92m｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡\x1b[1;91m
\033[1;39m  ➙ YOUR LICENSE NOT ACTIVATION 
 ➙ TOOL VIP T  A  R  M  A  Y  ☠
 ➙ SYSTEM TOOL TARMAY POWER FULL SECRUITY 🔥🔥    
\x1b[1;92m｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
""")
os.system('clear')
banner()
...
def crack(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r{x}[{H}T  A  R  M  A  Y  ☠{x}]{loop}{U}|{H}{ok}"),
	sys.stdout.flush()
